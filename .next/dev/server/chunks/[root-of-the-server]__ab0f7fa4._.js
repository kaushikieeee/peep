...
async function GET() {
    ...
    ;
    try {
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code$2f$lib$2f$googleSheetsAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSheetData"])(SHEET_ID, 'evidence!A2:O1000');
        ...
        const evidence = rows.map((row, idx)=>{
            return {
                ...
                status: row[11] || 'Open',
                images: (row[12] || '').split('|').filter((s)=>s.trim()),
                assignedTo: row[13] || '',
                assignedDate: row[14] || ''
            };
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab0f7fa4._.js.map