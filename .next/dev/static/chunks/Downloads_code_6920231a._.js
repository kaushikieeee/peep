...
function ZoneEditor() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$code$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ZoneEditor.useEffect": ()=>{
            // Load reports from API
            fetch('/api/data/reports').then({
                "ZoneEditor.useEffect": (r)=>r.json()
            }["ZoneEditor.useEffect"]).then({
                "ZoneEditor.useEffect": (data)=>{
                    setReports(data.map({
                        "ZoneEditor.useEffect": (r)=>({
                                id: r.id,
                                lat: r.lat,
                                lng: r.lng,
                                category: r.category,
            ...
            }["ZoneEditor.useEffect"]).catch({
                "ZoneEditor.useEffect": (err)=>console.error('Failed to load reports:', err)
            }["ZoneEditor.useEffect"]);
        }
    }["ZoneEditor.useEffect"], []);
    const handleAddZone = ()=>{
...
_s(ZoneEditor, "DDBj/wHc9vO8qKDMD+loCVov32I=");
_c = ZoneEditor;
var _c;
...
//# sourceMappingURL=Downloads_code_6920231a._.js.map