  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/20 backdrop-blur-xl bg-white/5">
        ...
        <h1 className="text-lg font-semibold text-white">What type of problem?</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="px-4 py-2 bg-white/5 flex justify-between items-center text-xs font-semibold overflow-x-auto gap-1 border-b border-white/20">
        ...
        <div className="flex flex-col items-center flex-shrink-0 opacity-50">
          <div className="w-6 h-6 rounded-full flex items-center justify-center bg-white/20 text-white/60 text-xs">4</div>
      ...
      <div className="flex-1 px-4 py-4 flex flex-col">
        ...
        <div className="space-y-2 flex-1 overflow-y-auto">
          {categories.map((category) => (
            ...
            >
              {category}
              {selected === category && <span className="float-right">✓</span>}
            </button>
          ))}
        </div>
