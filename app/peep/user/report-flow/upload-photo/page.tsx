      ...
      <div className="flex-1 px-4 py-6 flex flex-col items-center justify-center">
        {photo ? (
          ...
          <div className="w-full max-w-sm text-center space-y-4">
            ...
            <p className="text-sm text-gray-600">Take a clear photo of the environmental issue you've found.</p>
            <label className="block w-full py-3 px-4 rounded-lg font-semibold text-white cursor-pointer" style={{ backgroundColor: 'var(--peep-primary)' }}>
